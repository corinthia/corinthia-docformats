...
(function() {
    ...
    angular
        .module('corTest')
        .controller('DFNodePathsCtrl', DFNodePathsCtrl);

    DFNodePathsCtrl.$inject = ['$scope', '$routeParams', '$http', 'd3Service'];

    /* @ngInject */
    function DFNodePathsCtrl($scope, $routeParams, $http, d3Service) {
